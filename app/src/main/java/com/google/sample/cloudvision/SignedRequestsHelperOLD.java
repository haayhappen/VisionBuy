...
public class SignedRequestsHelperOLD {
    ...
    public SignedRequestsHelperOLD() throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException {

        //Encode secret key
        //String awsSecretKeyEncoded = URLEncoder.encode(awsSecretKey, "utf-8");

        //Log.d("SignedRequestHelper","Encoded Secret Key: "+awsSecretKeyEncoded);
